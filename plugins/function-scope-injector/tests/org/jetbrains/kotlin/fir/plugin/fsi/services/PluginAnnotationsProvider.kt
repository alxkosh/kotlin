...
class PluginAnnotationsProvider(testServices: TestServices) : EnvironmentConfigurator(testServices) {
    companion object {
        private const val ANNOTATIONS_JAR_DIR = "plugins/function-scope-injector/plugin-annotations/build/libs/"
    ...
    private val failMessage = { "Jar with annotations does not exist. Please run :plugins:function-scope-injector:plugin-annotations:jar" }
}
